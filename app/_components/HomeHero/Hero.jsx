...
function Hero() {
  return (
    <div className="img min-h-screen  flex justify-center items-center">
      <div className="container m-auto">
        <div className="text-center" >
           ...
           <div>
             ...
             Menu</Link>
             <Link href={'/about'} className="btn ml-3  border-none rounded-4xl text-[18px] w-45 tracking-[3]"> Learn More</Link>
           </div>
      </div>
      </div>  
    </div>
